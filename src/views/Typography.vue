<template>
  <section class="l-content l-content-typography">
    ...
    <div class="c-panel c-panel-typography" id="graphik">
      ...
      <div class="flex margin-xl">
        <div style="flex-basis: 25%;">
          <h3 style="margin-top: 0; margin-bottom: 4px;">Line Height</h3>
        ...
        <div style="flex-basis: 75%;">
          ...
          <div class="flex margin-xl">
            <div style="flex-basis: 25%; display: flex; align-items: baseline;">
              <div class="flex" style="align-items: center; justify-content: space-between;">
                <label style="justify-content: center; font-weight: bold;">Tight</label>
                <res-input
                  ><input
                    type="text"
            ...
            <span
              style="font-size:44px; flex-basis: 75%; margin-left: 12px; font-weight: bold;"
              v-bind:style="{ lineHeight: lineHeight.tight }"
              >Tight applies to larger font sizes, like those used in headlines</span
            >
          </div>
          ...
          <div class="flex margin-xl">
            <div style="flex-basis: 25%; display: flex; align-items: baseline;">
              <div class="flex" style="align-items: center; justify-content: space-between;">
                <label style="justify-content: center; font-weight: bold;">Medium</label>
                <res-input
                  ><input
                    type="text"
          ...
          <div class="flex margin-xl">
            <div style="flex-basis: 25%; display: flex; align-items: baseline;">
              <div class="flex" style="align-items: center; justify-content: space-between;">
                <label style="justify-content: center; font-weight: bold;">Loose</label>
                <res-input
                  ><input
                    type="text"
          ...
          <div class="flex margin-xl">
            <div style="flex-basis: 25%; display: flex; align-items: baseline;">
              <div class="flex" style="align-items: center; justify-content: space-between;">
                <label style="justify-content: center; font-weight: bold;">Body</label>
                <res-input
                  ><input
                    type="text"
            ...
            <span
              style="font-size:18px; flex-basis: 75%; margin-left: 12px;"
      ...
      <div class="flex margin-xl">
        <div style="flex-basis: 25%;">
          <h3 style="margin-top: 0; margin-bottom: 4px;">Letterspacing</h3>
        ...
        <div style="flex-basis: 75%;">
          ...
          <div class="flex margin-xl">
            <div style="flex-basis: 25%; display: flex; align-items: baseline;">
              <div class="flex" style="align-items: center; justify-content: space-between;">
                <label style="justify-content: center; font-weight: bold;">Default</label>
                <res-input
                  ><input
                    type="text"
          ...
          <div class="flex margin-xl">
            <div style="flex-basis: 25%; display: flex; align-items: baseline;">
              <div class="flex" style="align-items: center; justify-content: space-between;">
                <label style="justify-content: center; font-weight: bold;">Caps</label>
                <res-input
                  ><input
                    type="text"
    ...
    <div class="c-panel c-panel-typography" id="lora">
      <h2 class="margin-xl lora-bold" style="margin-top: 0;">Lora <span class="type-regular">Regular, Bold</span></h2>
