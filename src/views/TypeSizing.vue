<template>
    <section class="l-content">
        ...
        <div class="c-panel">
            ...
            <p class="margin-lg">
                The small scale in Harmony is based on a minor third scale with
                a 1.125 Base font size. Each step on the scale increases by TK
                TK. The mobile sizes are TK TK smaller.
            </p>
