  ...
  <aside class="l-sidebar">
    <nav class="c-nav">
      ...
      <ul>
        ...
        <li class="expandable" v-on:click="expand">
          Typography<res-icon name="up" size="small"></res-icon>
        </li>

        <li class="sub"><router-link to="/fonts">Fonts</router-link></li>
        <li class="sub"><router-link to="/typesizing">Sizes</router-link></li>

        <li class="sub expandable">
          Character Spacing<res-icon name="up" size="small"></res-icon>
        </li>
        ...
        <li class="sub expandable">
          Tokens<res-icon name="up" size="small"></res-icon>
        </li>
        <li class="sub sub-sub">
        ...
        <li class="expandable">
          Colors<res-icon name="up" size="small"></res-icon>
        </li>
...
export default {
  ...
  methods: {
    expand: function() {
      alert("need to refactor this for collapse functionality");
    }
  }
};
</script>
